...
abstract class GoodCollectible extends Collectible {
    public GoodCollectible(float x, float y, String assetKey, CollectibleType type) {
        super(x, y, STANDARD_SIZE, STANDARD_SIZE, assetKey, type, Tags.COLLECTIBLE_GOOD);
        setColor(1f, 1f, 0f);
    }

    protected GoodCollectible(float x, float y, float width, float height, String assetKey, CollectibleType type) {
