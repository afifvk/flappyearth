...
public class GameplayHudRenderer {
    ...
    public GameplayHudRenderer(ScoreManager scoreManager,
        ...
        this.font = FontUtils.loadFontOrDefault("fonts/BoldPixels.ttf", 24);
        this.font.getData().setScale(2.6f);
        this.font.setUseIntegerPositions(false);
        enableSmoothing(this.font);

        this.smallFont = FontUtils.loadFontOrDefault("fonts/BoldPixels.ttf", 18);
    ...
    public void render(ShapeRenderer sr, SpriteBatch batch,
        ...
        font.getData().setScale(2.08f * s);
        layout.setText(font, scoreText);
        float scoreX = screenW - pad - layout.width;
        float heartRowY = screenH - (60f * s);
        float heartSize = 32f * s;
        float scoreY = heartRowY + (heartSize * 0.75f);
